...
{
    public class AutorizacionAdminAttribute : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (userId == null || rol != "Administrador")
            {
    ...
    public class AutorizacionAllAttribute : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            // Obtener datos del usuario actual
